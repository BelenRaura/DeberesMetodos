...
\$ \sum\_\{i=1\}\^{}\{10\} \frac{1}{i^2} \$

Primero por: \$ 1 + \frac{1}{4} + \ldots + \frac{1}{100} \$

Y luego por: \$ \frac{1}{100} + \frac{1}{81} + \ldots + 1 \$
...
\$ \sum\_\{i=1\}\^{}\{10\} \frac{1}{i^3} \$ Primero por: \$ 1 +
\frac{1}{8} + \frac{1}{27} + \ldots + \frac{1}{1000} \$ y luego por: \$
...
\item
  ...
  \frac{1^{2i-1}}{2i-1} = \sum}\{i=1\}\^{}n (-1)\^{}\{i+1\}
  \frac{1}{2i-1} \$
